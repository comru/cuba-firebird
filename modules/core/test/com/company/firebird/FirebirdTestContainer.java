...
public class FirebirdTestContainer extends TestContainer {

    public FirebirdTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/firebird/app.properties",
    ...
    public static class Common extends FirebirdTestContainer {

        public static final FirebirdTestContainer.Common INSTANCE = new FirebirdTestContainer.Common();
